  ...
  <body>
    <div class="login-boxtitle">
      <a href="home/demo.html">
        <img alt="" src="/ho/images/logobig.png" /></a>
    </div>
    <div class="res-banner">
      <div class="res-main">
        <div class="login-banner-bg">
          <span></span>
          <img src="/ho/images/big.jpg" /></div>
        <div class="login-box">
          <div class="am-tabs" id="doc-my-tabs">
            ...
            <div class="am-tabs-bd">
                ...
                <!-- <div class="login-links">
                  <label for="reader-me">
                    <input id="reader-me" type="checkbox">点击表示您同意商城《服务协议》</label>
                </div> -->
              	</div>
              <div class="am-tab-panel">
                <form method="post">
                  <div class="user-phone">
                    ...
                    <input type="tel" name="" id="phone" placeholder="请输入手机号"></div>
